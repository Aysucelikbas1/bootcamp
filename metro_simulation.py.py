...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        kuyruk = deque([(baslangic, [baslangic])])  # (şu anki istasyon, o ana kadar izlenen rota)
        ziyaret_edilen = set()
        ...
        while kuyruk:
            ...
            if mevcut == hedef:
                return rota  # Hedefe ulaşıldı, en az aktarmalı rota döndürülüyor
        ...
        return None  # Eğer hedefe ulaşan bir yol yoksa
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        pq = [(0, id(baslangic), baslangic, [baslangic])]  # (toplam süre, id, istasyon, rota)
        ziyaret_edilen = {}
        ...
        while pq:
            ...
            if mevcut == hedef:
                return rota, toplam_sure  # Hedefe ulaşıldı, en hızlı rota ve süresi döndürülüyor
            
            if mevcut in ziyaret_edilen and ziyaret_edilen[mevcut] <= toplam_sure:
                continue  # Daha kısa sürede ulaşılmışsa tekrar işleme gerek yok
